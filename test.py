...
class MainUI(QDialog):
    ...
    def create_layout(self):
        ...
        load_vehicle_layout.addWidget(self.vehicle_menu)
    ...
    def choose_vehicle(self):
        #Sets vehicle path
        file_path = QFileDialog.getOpenFileName(None, "", self.user_profile + self.vehicle_library_dir, "Vehicles (*.mb *.obj *.fbx);;All Files (*.*)")[0]
